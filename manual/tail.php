...
$ip = $handle = fopen("./manual.log", "a"); //open log use "a" to write and grow log no deletion or use "r+" writes 1 line to the log it also deletes log
...
$logFile = "./manual.log"; // local path to log file
...
<form action="./tail.php?action=post" method="post">	 
<input type="text" name="username" class="usernameInput" style="height: 50px; width: 259px;"  style="text-align:left;" type="text" maxlength="14" autospell="false" autocomplete="false" autocorrect="off" autocapitalize="off" placeholder="type in chat" />
</form>
<br>
</button>
</body>	
